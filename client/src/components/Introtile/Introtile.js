	...
	return (
		<div className="Introtile-Full-Container">
			<div className="Introtile-IMG-Container">
				<img src="./Assets/Images/IntroTileBKG72DPIShorter2.jpg" alt="BkgImgVehicle" className="Introtile-CarBKG" />
			</div>
			<MDBContainer className="Introtile-MDB-Container text-left">
				...
				<Fragment>
					<MDBBtn id="Introtile-Book-BTN" className="text-left" color="danger-color-dark">
